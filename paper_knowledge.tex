...
In order to better understand the overall process the {\sc Dialogs} module and its relation with ORO, we next describe the different steps of the approach based on three examples. In these examples, we
...
parsing of the sentence (algorithm~\ref{algo|Resolution}(\ref{res.desc})). In the example, a banana (\stmt{?obj type Banana})

...
%\begin{figure}%[!t] 
%\centering
%\includegraphics[width=0.8\columnwidth]{images/looks.jpg} \caption{Representation
...
\begin{figure*}[!t]
	\subfigure[]
	{\includegraphics[width=0.35\linewidth]{images/looks.jpg} \label{(a)}} \quad
	\subfigure[]
	{\includegraphics[width=0.3\linewidth]{images/reach.jpg} \label{(b)}}\qquad	
	\subfigure[]
	{\includegraphics[width=0.25\linewidth]{images/spatial_relation.png} \label{(c)}} 
...
%\begin{figure} 
%	\centering
%	\includegraphics[width=0.6\columnwidth]{images/spatial_relation.png}
...
\centering
	\subfigure[]
	{\includegraphics[width=0.3\linewidth]{images/situationAssessment1.png}\label{(a)}}
	\subfigure[]
	{\includegraphics[width=0.3\linewidth]{images/situationAssessment2.png}\label{(b)}}
	\subfigure[]
  	{\includegraphics[width=0.3\linewidth]{images/inTheBox2.jpg}\label{c}}

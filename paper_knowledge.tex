...
\caption{(a) Rosie, looking for objects it may know, and (b) viewed in Willow
...
\centering
	...
	\chatN{rosie} &\emph{[add \stmt{obj\_01 label "Rosie's mug"}]}\\
				& What kind of object is ``Rosie's mug''? \\
	\chatN{human} & Mug \\
	\chatN{rosie} & \emph{[add \stmt{obj\_01 type Mug}]}\\
			& What is a Mug?\\ 
	\chatN{human} & Tableware\\
	\chatN{rosie} & \emph{[adds \stmt{Mug subClassOf Tableware}. Rosie knows about \emph{Tableware} --it belongs to the common-sense ontology--.}\\
	 & (...) \\
